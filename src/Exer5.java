...
public class Exer5 {
    ...
    private static void inserir_aluno(Aluno[] cadastro, int[] total_alunos, Scanner scan){
        ...
        cadastro[total_alunos[0]] = novo; // será igual aos dados inseridos
        total_alunos[0]++;
    }
    ...
    public static void main(String[] args){
        try(Scanner scan = new Scanner(System.in)){
            ...
            int[] total_alunos = {0}; // contador de alunos cadastrados - usamos array pois o valor é passado por referencia
            ...
            do {
                switch (op = menu(scan)) {
                    ...
                    case 2:
                        ...
                        for(int i=0; i<total_alunos[0]; i++){
                    ...
                    case 3:
                        ...
                        switch (opcao) {
                            case 1:
                                for(int i =0; i<total_alunos[0]; i++){
                                    for(int j=i+1; j<total_alunos[0]; j++){
